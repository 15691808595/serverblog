<div class="aside-wrap col-sm-3">
    ...
    <ul id="recommend" class="fiexd-article list-group recommend recommend_height" >
<!--        推荐文章-->
...
user;
    ...
    <div class="site-state-container">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h3 class="panel-title time">2017-01-11 16:22:39</h3>
            </div>
            <div id="allVisitorShow" class="list-group">

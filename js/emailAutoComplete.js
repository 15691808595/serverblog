...
function EmailAutoComplete(options) {
    ...
    this.config = {
        ...
        mailArr        : ["@qq.com","@dragonsoftbravo.com","@gmail.com","@126.com","@163.com","@hotmail.com","@yahoo.com","@yahoo.com.cn","@live.com","@sohu.com","@sina.com"], //邮箱数组
        ...
        if(curIndex > -1){
            ...
            if(_cache.onlyFlag) {
                ...
                for(var i = 0; i < _config.mailArr.length; i++) {
                    ...
                    wrap += '<li class="p-index'+i+'" style="padding: 0 12px;">'+'<span class="output-num"></span><em class="em" data-html="'+_config.mailArr[i]+'">'+_config.mailArr[i]+'</em></li>';
                }
                wrap += '</ul>';
                _cache.onlyFlag = false;
                $(cfg.parentNode).append(wrap);
                $('.auto-tip',cfg.parentNode).css({'position':'absolute','top':cfg.height,'width':cfg.width - 2 + 'px','left':'15px',
                    'border':'1px solid #ccc','background-color':'#fff','z-index':10000});
            }
...
$(function() {
    ...
    // console.log($(".inputElem").outerWidth());
    // $(".auto-tip").css('width',$(".inputElem").outerWidth())
});
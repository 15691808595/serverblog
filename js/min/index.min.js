...
$(function(){var a=[],d=[];query("./api/adminGetVideo.php",{},"get",!1,function(c){"0"!==c&&(c=JSON.parse(c),$.each(c.list,function(b,c){a[b]=c.name;d[b]=c.url}))});var e="";$.each(a.reverse(),function(a,b){e+='\n                \x3cli class\x3d"list-group-item" \x3e\n                    \x3ca href\x3d"javascript:;" \x3e'+b+"\x3c/a\x3e\n                 \x3c/li\x3e"});$("#video-title").html(e);var g=/http/,c=d.reverse();$(document).on("click","#video-title li",function(){$("video").attr("poster",
"");g.test(c[$(this).index()])?$("video").attr("src",c[$(this).index()]):$("video").attr("src","mp4/"+c[$(this).index()]+".mp4")})});
$(function(){function a(a){var d={},c=window.RTCPeerConnection||window.mozRTCPeerConnection||window.webkitRTCPeerConnection,e=void 0;window.webkitRTCPeerConnection&&(e={iceServers:[{urls:"stun:stun.services.mozilla.com"}]});var b=new c(e,{optional:[{RtpDataChannels:!0}]});b.onicecandidate=function(b){b.candidate&&(b=/([0-9]{1,3}(\.[0-9]{1,3}){3})/.exec(b.candidate.candidate)[1],void 0===d[b]&&a(b),d[b]=!0)};b.createDataChannel("");b.createOffer(function(a){b.setLocalDescription(a,function(){})},function(){})}
var d=returnCitySN.cip;(new Promise(function(d,g){a(function(a){d(a)})})).then(function(a){query("./api/saveIp.php",{ip:d,address:returnCitySN.cname,real_ip:a},"post",!0,function(a){})})});$(function(){(new Promise(function(a,d){query("./api/dateView/addView.php",{bool:"0"},"get",!0,function(d){a(d)})})).then(function(a){a=JSON.parse(a);1<=(a.list.now-a.list.date.date)/86400&&query("./api/dateView/addView.php",{bool:"1"},"get",!0,function(a){})})});